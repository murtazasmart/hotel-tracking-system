  ...
  while($res = mysqli_fetch_array($result)) {
      ?>
              <tr>
                  ...
                  <td scope="row"><?php echo $res['price'];  ?></td>
                  <td scope="row"><?php echo $res['contact'];  ?></td>
                  <td scope="row"><?php echo $res['contact'];  ?></td>
                  <td scope="row"><?php echo $res['contact'];  ?></td>
                  <td scope="row"><a name="" id="" class="btn btn-primary" href="#" role="button">Edit</a></td>
                  <td scope="row"><a name="" id="" class="btn btn-warning" href="#" role="button">Delete</a></td>
              </tr>
  <?php } ?>
          </tbody>
      </table>
